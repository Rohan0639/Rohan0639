...
<ul>
<li>Built FoodLog, a web app that lets users log meals in plain English and  converts them into structured format to track the users calories and macros by using  Gemini API to fetch food data .</li>
